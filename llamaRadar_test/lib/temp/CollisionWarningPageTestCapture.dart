...
class CollisionWarningPageTestCapture extends StatefulWidget {
  ...
  const CollisionWarningPageTestCapture({Key? key, required this.device}) : super(key: key);

  @override
  _CollisionWarningPage2State createState() => _CollisionWarningPage2State();
}

class _CollisionWarningPage2State extends State<CollisionWarningPageTestCapture> {
  late Timer _timer;
