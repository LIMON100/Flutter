...
// Main Dash Cam page
class DashCamCapture extends StatefulWidget {
  const DashCamCapture({Key? key}) : super(key: key);

  @override
  _DashCamCaptureState createState() => _DashCamCaptureState();
}

class _DashCamCaptureState extends State<DashCamCapture> {
