...
class CollisionWarningPageFirebase extends StatefulWidget {
  final BluetoothDevice device;

  const CollisionWarningPageFirebase({Key? key, required this.device}) : super(key: key);

  @override
  _CollisionWarningPageFirebaseState createState() => _CollisionWarningPageFirebaseState();
}

class _CollisionWarningPageFirebaseState extends State<CollisionWarningPageFirebase> {
  late Timer _timer;
