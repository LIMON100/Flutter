...
class _CollisionWarningPageState extends State<CollisionWarningPage> {
  ...
  void _startBlinking3() {
    ...
    _blinkTimer = Timer.periodic(Duration(milliseconds: 500), (timer) {
      setState(() {
        _isBlinkingIcon1 = (int.tryParse(_value[15]) == 6) ? !_isBlinkingIcon1 : false;
        _isBlinkingIcon2 = (int.tryParse(_value[15]) == 9) ? !_isBlinkingIcon2 : false;
        _isBlinking = !_isBlinking;
      });
    });
    // Stop the blinking after 3 seconds
  ...
  void _handleButtonPress() {
    if (int.tryParse(_value[15]) == 6 || int.tryParse(_value[15]) == 9) {
      _startBlinking3();
    }
  }
